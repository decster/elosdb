...
| hot | **1.008** | **1 of 81** | Umbra 1.253 |
| cold | **1.477** | **1 of 77** | Umbra 1.942 |
| load | 59.8 s | | |
| data size | 8,028,674,152 B | smallest in the field | Umbra 8.30 GB |
| concurrent QPS | 3.822 | | |
...
The run that produced these numbers installed the `v0.1.1` release from this
repository's releases page on a fresh instance and compiled nothing. Three instances
of this code have scored `combined` 1.376, 1.366 and 1.388 on identical data; the
number published here is the run of the scripts and the binary in this repository,
...
## Running it
    ...
    curl -fsSLO https://github.com/decster/elosdb/releases/download/v0.1.1/elosdb-v0.1.1-linux-aarch64
    sha256sum elosdb-v0.1.1-linux-aarch64      # compare against the release notes
    chmod +x elosdb-v0.1.1-linux-aarch64
    ./elosdb-v0.1.1-linux-aarch64 --data-dir /path/to/store --port 5432
